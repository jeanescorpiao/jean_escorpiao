...
function NovoPersonagem() {
	...
	numero++;
	novaDiv = document.createElement("for1");
    novaDiv.innerHTML = `			
	<div id="for1"></div>	
	<form class="form">
	 </br></br>
		   ...
		   <label for="nome-personagem">Força</label>
			...
			<div class= "for2">
				<div class="nação2">
					...
					<input type="radio" name="Nação">Elfo da Floresta</br>
			...
			<div class="button">
				<button>Criar Personagem Novo</button>
				<button  type="button" onclick="NovoPersonagem()" >Novo Personagem2</button>
			</div>
